...
class Handlers(commands.Cog):
    ...
    async def on_command_error(self, ctx, error):
        ...
        if isinstance(error, NotVoted):
            embed = discord.Embed(title="Oops!", description="This command is for voters only! You can vote for me [here](https://top.gg/bot/502205162694246412) to use this command.", colour=discord.Colour.blue())
