...
class Bot(commands.Bot):
    ...
    async def create_pool(self):
        return await asyncpg.connect(host=os.environ.get("DATABASE_HOST"), database=os.environ.get("DATABASE"), user=os.environ.get("PG_NAME"), password=os.environ.get("PG_PASSWORD"))
